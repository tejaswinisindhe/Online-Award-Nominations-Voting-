...
<p align="center" class="style2">New Nominee's Registration</p>
...
<form id="form1" name="form1" method="post" action="">
  <table bgcolor="#CCCCCC" width="317" height="272" border="0" align="center">
    <tr>
	 ...
	 <tr>
      <td><div align="right"><span class="style3">Nominee Voter ID</span></div></td>
      <td><div align="left"><span class="style3">
      ...
      <td><div align="left"><span class="style3">
		 ...
		 <select name="s3">
		<option>Best Actor Award</option>
		<option>Best Dancer Award</option>
		<option>Best singer Award</option>
		<option>Best Director Award</option>
		<option>Best Anchor Award</option>
		<option>Best Actor in supporting role Award</option>
		<option>Best Story of the year Award</option>
		</select>
      </span></div></td>
    </tr>
    <tr>
