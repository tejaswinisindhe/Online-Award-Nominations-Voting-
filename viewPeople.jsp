...
<div style="overflow-x:auto;">
 ...
 %>
 <center>
   <p style="color:#000099; font-size:24px;"> Voting lines are : <%= rst.getString(1) %></p></center>
...
out.print(otpnum);
    ...
    final String from = "onlinevotingforawards@gmail.com";

    final String pass = "uxcbncrjvsepwkwo";
